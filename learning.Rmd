...
# plot(train_cut$raw_timestamp_part_1, train_cut$classe, xlim=c(1322673020,1322673170))
# plot(train_cut$raw_timestamp_part_1, train_cut$classe, xlim=c(1322832770,1322832950))
```
